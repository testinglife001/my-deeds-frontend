...
import { delete_tag, get_all_tag } from '../../store/actions/dashboard/tagAction';
...
const AllTag = () => {
  ...
  const { allTag, perPage, tagCount, tagSuccessMessage } = useSelector(state=>state.dashboardTagReducer);
  // console.log(allTag);
